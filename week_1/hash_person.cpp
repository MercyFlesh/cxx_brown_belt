...
struct Address {
    ...
    {
        return make_tuple(city, street, building) ==
            make_tuple(other.city, other.street, other.building);
    }
};
...
struct Person {
    ...
    {
        return make_tuple(name, height, weight, address) ==
            make_tuple(other.name, other.height, other.weight, other.address);
    }
};
...
struct AddressHasher {
    size_t operator() (const Address& address) const
    {
        ...
        return h_str(address.city) ^ h_str(address.street) ^ h_int(address.building);
    }
};
...
struct PersonHasher {
    size_t operator() (const Person& person) const
    {
        ...
        AddressHasher h_addres;

        return h_str(person.name) ^ h_int(person.height) ^ h_double(person.weight) ^ h_addres(person.address);
    }
};
